...
"$APP_NAME — Réinstallation"
        ...
        uninstall)
            popup_question \
"Voulez-vous supprimer votre configuration ET vos profils ?
(dossiers synchronisés, répertoire de sauvegarde, profils de téléphones)

Si vous répondez NON, votre configuration sera conservée
et vous la retrouverez lors d'une réinstallation." \
...
Configuration et profils conservés dans :
