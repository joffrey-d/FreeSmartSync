...
def main():
    ...
    if os.path.exists(_ICON_PATH):
        # Essai 1 : icône depuis thème XDG (KDE la trouve mieux ainsi)
        _xdg_icon = QtGui.QIcon.fromTheme("freesmartsync", QtGui.QIcon(_ICON_PATH))
        if _xdg_icon.isNull():
            _xdg_icon = QtGui.QIcon(_ICON_PATH)
        app.setWindowIcon(_xdg_icon)
        QtWidgets.QApplication.setWindowIcon(_xdg_icon)
